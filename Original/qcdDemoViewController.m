...
- (void)viewDidLoad
{
    ...
    if([defaults objectForKey:@"companyList"] != nil)
    {
        NSData *decodeObject = [defaults objectForKey:@"companyList"];
        self.dAO.companyList = [NSKeyedUnarchiver unarchiveObjectWithData:decodeObject];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell with the information that we would like it to display
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    // Separate the string by newline
